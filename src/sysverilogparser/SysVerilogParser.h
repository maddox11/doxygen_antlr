...
class  SysVerilogParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleInclude_path = 0, RuleLibrary_description = 1, RuleSource_code = 2, 
    RuleDescription = 3, RuleModule_nonansi_header = 4, RuleModule_declaration = 5, 
    RuleModule_keyword = 6, RuleInterface_declaration = 7, RuleInterface_nonansi_header = 8, 
    RuleProgram_declaration = 9, RuleProgram_nonansi_header = 10, RuleChecker_declaration = 11, 
    RuleClass_declaration = 12, RuleInterface_class_type = 13, RuleInterface_class_declaration = 14, 
    RuleInterface_class_item = 15, RuleInterface_class_method = 16, RulePackage_declaration = 17, 
    RuleTimeunits_declaration = 18, RuleParameter_port_list = 19, RuleParameter_port_declaration = 20, 
    RuleParameter_declaration = 21, RuleList_of_ports = 22, RuleList_of_port_declarations = 23, 
    RuleParam_assignment = 24, RuleList_of_param_assignments = 25, RulePort_declaration = 26, 
    RulePort = 27, RulePort_expression = 28, RulePort_reference = 29, RulePort_direction = 30, 
    RuleNet_port_header = 31, RuleVariable_port_header = 32, RuleInterface_port_header = 33, 
    RuleAnsi_port_declaration = 34, RuleElaboration_system_task = 35, RuleFinish_number = 36, 
    RuleModule_common_item = 37, RuleModule_item = 38, RuleModule_or_generate_item = 39, 
    RuleModule_or_generate_item_declaration = 40, RuleNon_port_module_item = 41, 
    RuleParameter_override = 42, RuleBind_directive = 43, RuleBind_target_instance = 44, 
    RuleBind_target_instance_list = 45, RuleBind_instantiation = 46, RuleConfig_declaration = 47, 
    RuleDesign_statement = 48, RuleConfig_rule_statement = 49, RuleDefault_clause = 50, 
    RuleInst_clause = 51, RuleInst_name = 52, RuleCell_clause = 53, RuleLiblist_clause = 54, 
    RuleUse_clause = 55, RuleInterface_or_generate_item = 56, RuleExtern_tf_declaration = 57, 
    ...
    RuleChecker_port_item = 64, RuleChecker_port_direction = 65, RuleChecker_or_generate_item = 66, 
    RuleChecker_or_generate_item_declaration = 67, RuleChecker_generate_item = 68, 
    RuleClass_item = 69, RuleClass_property = 70, RuleClass_method = 71, 
    RuleClass_constructor_prototype = 72, RuleClass_constraint = 73, RuleClass_item_qualifier = 74, 
    RuleProperty_qualifier = 75, RuleRandom_qualifier = 76, RuleMethod_qualifier = 77, 
    RuleMethod_prototype = 78, RuleClass_constructor_declaration = 79, RuleConstraint_declaration = 80, 
    RuleConstraint_block = 81, RuleConstraint_block_item = 82, RuleSolve_before_list = 83, 
    RuleConstraint_primary = 84, RuleConstraint_expression = 85, RuleUniqueness_constraint = 86, 
    RuleConstraint_set = 87, RuleDist_list = 88, RuleDist_item = 89, RuleDist_weight = 90, 
    RuleConstraint_prototype = 91, RuleConstraint_prototype_qualifier = 92, 
    RuleExtern_constraint_declaration = 93, RuleIdentifier_list = 94, RulePackage_item = 95, 
    RulePackage_or_generate_item_declaration = 96, RuleAnonymous_program = 97, 
    RuleAnonymous_program_item = 98, RuleLocal_parameter_declaration = 99, 
    RuleSpecparam_declaration = 100, RuleInout_declaration = 101, RuleInput_declaration = 102, 
    RuleOutput_declaration = 103, RuleInterface_port_declaration = 104, 
    RuleRef_declaration = 105, RuleUuu = 106, RuleData_declaration = 107, 
    RulePackage_import_declaration = 108, RulePackage_import_item = 109, 
    RulePackage_export_declaration = 110, RuleGenvar_declaration = 111, 
    RuleNet_declaration = 112, RuleType_declaration = 113, RuleNet_type_declaration = 114, 
    RuleLifetime = 115, RuleCasting_type = 116, RuleData_type = 117, RuleData_type_or_implicit = 118, 
    RuleData_type_or_implicit1 = 119, RuleImplicit_data_type = 120, RuleEnum_base_type = 121, 
    RuleEnum_name_declaration = 122, RuleClass_scope = 123, RuleClass_type1 = 124, 
    RuleClass_type = 125, RuleInteger_type = 126, RuleInteger_atom_type = 127, 
    RuleInteger_vector_type = 128, RuleNon_integer_type = 129, RuleNet_type = 130, 
    RuleNet_port_type = 131, RuleVariable_port_type = 132, RuleVar_data_type = 133, 
    RuleSigning = 134, RuleSimple_type = 135, RuleStruct_union_member = 136, 
    RuleData_type_or_void = 137, RuleStruct_union = 138, RuleType_reference = 139, 
    RuleDrive_strength = 140, RuleStrength0 = 141, RuleStrength1 = 142, 
    RuleCharge_strength = 143, RuleDelay3 = 144, RuleDelay2 = 145, RuleDelay_value = 146, 
    RuleList_of_defparam_assignments = 147, RuleList_of_genvar_identifiers = 148, 
    RuleList_of_interface_identifiers = 149, RuleList_of_net_decl_assignments = 150, 
    RuleList_of_port_identifiers = 151, RuleList_of_udp_port_identifiers = 152, 
    RuleList_of_specparam_assignments = 153, RuleList_of_tf_variable_identifiers = 154, 
    RuleList_of_type_assignments = 155, RuleList_of_variable_decl_assignments = 156, 
    RuleList_of_variable_identifiers = 157, RuleList_of_variable_port_identifiers = 158, 
    RulePort_id = 159, RuleDefparam_assignment = 160, RuleNet_decl_assignment = 161, 
    RuleSpecparam_assignment = 162, RuleType_assignment = 163, RulePulse_control_specparam = 164, 
    RuleError_limit_value = 165, RuleReject_limit_value = 166, RuleLimit_value = 167, 
    RuleVariable_decl_assignment = 168, RuleClass_new = 169, RuleDynamic_array_new = 170, 
    RuleUnpacked_dimension = 171, RulePacked_dimension = 172, RuleAssociative_dimension = 173, 
    RuleVariable_dimension = 174, RuleQueue_dimension = 175, RuleUnsized_dimension = 176, 
    RuleFunction_data_type_or_implicit = 177, RuleFunction_declaration = 178, 
    RuleFunction_body_declaration = 179, RuleFunction_dec = 180, RuleFunction_prototype = 181, 
    RuleDpi_import_export = 182, RuleDpi_spec_string = 183, RuleDpi_function_import_property = 184, 
    RuleDpi_task_import_property = 185, RuleDpi_function_proto = 186, RuleDpi_task_proto = 187, 
    RuleTask_declaration = 188, RuleTask_body_declaration = 189, RuleTask_decl = 190, 
    RuleTf_item_declaration = 191, RuleTf_port_list = 192, RuleTf_port_item = 193, 
    RuleTf_port_direction = 194, RuleTf_port_declaration = 195, RuleTask_prototype = 196, 
    RuleBlock_item_declaration = 197, RuleOverload_declaration = 198, RuleOverload_operator = 199, 
    RuleOverload_proto_formals = 200, RuleModport_declaration = 201, RuleModport_item = 202, 
    RuleModport_ports_declaration = 203, RuleModport_clocking_declaration = 204, 
    RuleModport_simple_ports_declaration = 205, RuleModport_simple_port = 206, 
    RuleModport_tf_ports_declaration = 207, RuleModport_tf_port = 208, RuleImport_export = 209, 
    RuleConcurrent_assertion_item = 210, RuleConcurrent_assertion_statement = 211, 
    RuleAssert_property_statement = 212, RuleAssume_property_statement = 213, 
    RuleCover_property_statement = 214, RuleExpect_property_statement = 215, 
    RuleCover_sequence_statement = 216, RuleRestrict_property_statement = 217, 
    RuleProperty_instance = 218, RuleProperty_list_of_arguments = 219, RuleProperty_actual_arg = 220, 
    ...
    RuleProperty_case_item = 229, RuleSequence_declaration = 230, RuleSequence_port_list = 231, 
    RuleSequence_port_item = 232, RuleSequence_lvar_port_direction = 233, 
    RuleSequence_formal_type = 234, RuleSequence_expr = 235, RuleCycle_delay_range = 236, 
    RuleSequence_method_call = 237, RuleSequence_match_item = 238, RuleSequence_instance = 239, 
    RuleSequence_list_of_arguments = 240, RuleSequence_actual_arg = 241, 
    RuleBoolean_abbrev = 242, RuleSequence_abbrev = 243, RuleConsecutive_repetition = 244, 
    RuleNon_consecutive_repetition = 245, RuleGoto_repetition = 246, RuleConst_or_range_expression = 247, 
    RuleCycle_delay_const_range_expression = 248, RuleExpression_or_dist = 249, 
    RuleAssertion_variable_declaration = 250, RuleLet_declaration = 251, 
    RuleLet_identifier = 252, RuleLet_port_list = 253, RuleLet_port_item = 254, 
    RuleLet_formal_type = 255, RuleLet_expression = 256, RuleLet_list_of_arguments = 257, 
    RuleLet_actual_arg = 258, RuleCovergroup_declaration = 259, RuleCoverage_spec_or_option = 260, 
    RuleCoverage_option = 261, RuleCoverage_spec = 262, RuleCoverage_event = 263, 
    RuleBlock_event_expression = 264, RuleHierarchical_btf_identifier = 265, 
    RuleCover_point = 266, RuleBins_or_empty = 267, RuleBins_or_options = 268, 
    RuleBins_keyword = 269, RuleTrans_list = 270, RuleTrans_set = 271, RuleTrans_range_list = 272, 
    RuleTrans_item = 273, RuleRepeat_range = 274, RuleCover_cross = 275, 
    RuleList_of_cross_items = 276, RuleCross_item = 277, RuleCross_body = 278, 
    RuleCross_body_item = 279, RuleBins_selection_or_option = 280, RuleBins_selection = 281, 
    RuleSelect_expression2 = 282, RuleSelect_expression = 283, RuleSelect_condition = 284, 
    RuleBins_expression = 285, RuleCovergroup_range_list = 286, RuleCovergroup_value_range = 287, 
    RuleWith_covergroup_expression = 288, RuleSet_covergroup_expression = 289, 
    RuleInteger_covergroup_expression = 290, RuleCross_set_expression = 291, 
    RuleCovergroup_expression = 292, RuleGate_instantiation = 293, RuleCmos_switch_instance = 294, 
    RuleEnable_gate_instance = 295, RuleMos_switch_instance = 296, RuleN_input_gate_instance = 297, 
    RuleN_output_gate_instance = 298, RulePass_switch_instance = 299, RulePass_enable_switch_instance = 300, 
    RulePull_gate_instance = 301, RulePulldown_strength = 302, RulePullup_strength = 303, 
    RuleEnable_terminal = 304, RuleInout_terminal = 305, RuleInput_terminal = 306, 
    RuleNcontrol_terminal = 307, RuleOutput_terminal = 308, RulePcontrol_terminal = 309, 
    RuleCmos_switchtype = 310, RuleEnable_gatetype = 311, RuleMos_switchtype = 312, 
    RuleN_input_gatetype = 313, RuleN_output_gatetype = 314, RulePass_en_switchtype = 315, 
    RulePass_switchtype = 316, RuleModule_instantiation = 317, RuleParameter_value_assignment = 318, 
    ...
    RuleChecker_instantiation = 328, RuleList_of_checker_port_connections = 329, 
    RuleOrdered_checker_port_connection = 330, RuleNamed_checker_port_connection = 331, 
    RuleProgram_instantiation = 332, RuleGenerate_region = 333, RuleLoop_generate_construct = 334, 
    RuleGenvar_initialization = 335, RuleGenvar_iteration = 336, RuleConditional_generate_construct = 337, 
    ...
    RuleContinuous_assign = 343, RuleList_of_net_assignments = 344, RuleList_of_variable_assignments = 345, 
    RuleNet_alias = 346, RuleNet_assignment = 347, RuleInitial_construct = 348, 
    RuleAlways_construct = 349, RuleAlways_keyword = 350, RuleFinal_construct = 351, 
    RuleBlocking_assignment = 352, RuleOperator_assignment = 353, RuleAssignment_operator = 354, 
    RuleNonblocking_assignment = 355, RuleProcedural_continuous_assignment = 356, 
    RuleVariable_assignment = 357, RuleAction_block = 358, RuleSeq_block = 359, 
    RulePar_block = 360, RuleJoin_keyword = 361, RuleStatement_or_null = 362, 
    RuleStatement = 363, RuleStatement_item = 364, RuleFunction_statement = 365, 
    RuleFunction_statement_or_null = 366, RuleVariable_identifier_list = 367, 
    RuleProcedural_timing_control_statement = 368, RuleDelay_or_event_control = 369, 
    RuleDelay_control = 370, RulePound_delay_value = 371, RuleEvent_control = 372, 
    RuleEvent_expression = 373, RuleProcedural_timing_control = 374, RuleJump_statement = 375, 
    RuleWait_statement = 376, RuleEvent_trigger = 377, RuleDisable_statement = 378, 
    RuleConditional_statement = 379, RuleUnique_priority = 380, RuleCond_predicate = 381, 
    RuleExpression_or_cond_pattern = 382, RuleCond_pattern = 383, RuleCase_statement = 384, 
    RuleCcase = 385, RuleCase_keyword = 386, RuleCase_expression = 387, 
    RuleCase_item = 388, RuleCase_pattern_item = 389, RuleCase_inside_item = 390, 
    RuleCase_item_expression = 391, RuleRandcase_statement = 392, RuleRandcase_item = 393, 
    RuleOpen_range_list = 394, RuleOpen_value_range = 395, RulePattern = 396, 
    RuleAssignment_pattern = 397, RuleStructure_pattern_key = 398, RuleArray_pattern_key = 399, 
    RuleAssignment_pattern_key = 400, RuleAssignment_pattern_expression = 401, 
    RuleAssignment_pattern_expression_type = 402, RuleConstant_assignment_pattern_expression = 403, 
    RuleAssignment_pattern_net_lvalue = 404, RuleAssignment_pattern_variable_lvalue = 405, 
    RuleLoop_statement = 406, RuleFor_initialization = 407, RuleFor_variable_declaration = 408, 
    RuleFor_step = 409, RuleFor_step_assignment = 410, RuleLoop_variables = 411, 
    RuleSubroutine_call_statement = 412, RuleAssertion_item = 413, RuleDeferred_immediate_assertion_item = 414, 
    RuleProcedural_assertion_statement = 415, RuleImmediate_assertion_statement = 416, 
    RuleSimple_immediate_assertion_statement = 417, RuleSimple_immediate_assert_statement = 418, 
    RuleSimple_immediate_assume_statement = 419, RuleSimple_immediate_cover_statement = 420, 
    RuleDeferred_immediate_assertion_statement = 421, RuleDeferred_immediate_assert_statement = 422, 
    RuleDeferred_immediate_assume_statement = 423, RuleDeferred_immediate_cover_statement = 424, 
    RuleClocking_declaration = 425, RuleClocking_event = 426, RuleClocking_item = 427, 
    RuleDefault_skew = 428, RuleClocking_direction = 429, RuleList_of_clocking_decl_assign = 430, 
    RuleClocking_decl_assign = 431, RuleClocking_skew = 432, RuleClocking_drive = 433, 
    RuleCycle_delay = 434, RuleClockvar = 435, RuleClockvar_expression = 436, 
    RuleRandsequence_statement = 437, RuleProduction = 438, RuleRs_rule = 439, 
    RuleRs_production_list = 440, RuleWeight_specification = 441, RuleRs_code_block = 442, 
    RuleRs_prod = 443, RuleProduction_item = 444, RuleRs_if_else = 445, 
    RuleRs_repeat = 446, RuleRs_case = 447, RuleRs_case_item = 448, RuleSpecify_block = 449, 
    RuleSpecify_item = 450, RulePulsestyle_declaration = 451, RuleShowcancelled_declaration = 452, 
    RulePath_declaration = 453, RuleSimple_path_declaration = 454, RuleEdge_sensitive_path_declaration = 455, 
    RuleParallel_path_description = 456, RuleParallel_edge_sensitive_path_description = 457, 
    RuleFull_path_description = 458, RuleFull_edge_sensitive_path_description = 459, 
    RuleList_of_path_inputs = 460, RuleList_of_path_outputs = 461, RuleSpecify_input_terminal_descriptor = 462, 
    RuleSpecify_output_terminal_descriptor = 463, RuleInput_identifier = 464, 
    RuleOutput_identifier = 465, RulePath_delay_value = 466, RuleList_of_path_delay_expressions = 467, 
    RulePath_delay_expression = 468, RuleData_source_expression = 469, RuleEdge_identifier = 470, 
    RuleState_dependent_path_declaration = 471, RulePolarity_operator = 472, 
    RuleSystem_timing_check = 473, RuleSetup_timing_check = 474, RuleHold_timing_check = 475, 
    RuleSetuphold_timing_check = 476, RuleRecovery_timing_check = 477, RuleRemoval_timing_check = 478, 
    RuleRecrem_timing_check = 479, RuleSkew_timing_check = 480, RuleTimeskew_timing_check = 481, 
    RuleFullskew_timing_check = 482, RulePeriod_timing_check = 483, RuleWidth_timing_check = 484, 
    RuleNochange_timing_check = 485, RuleTimecheck_condition = 486, RuleControlled_reference_event = 487, 
    RuleData_event = 488, RuleDelayed_data = 489, RuleDelayed_reference = 490, 
    RuleEnd_edge_offset = 491, RuleEvent_based_flag = 492, RuleNotifier = 493, 
    RuleReference_event = 494, RuleRemain_active_flag = 495, RuleTimestamp_condition = 496, 
    RuleStart_edge_offset = 497, RuleThreshold = 498, RuleTiming_check_limit = 499, 
    RuleTiming_check_event = 500, RuleControlled_timing_check_event = 501, 
    RuleTiming_check_event_control = 502, RuleSpecify_terminal_descriptor = 503, 
    RuleEdge_control_specifier = 504, RuleEdge_descriptor = 505, RuleTiming_check_condition = 506, 
    RuleScalar_timing_check_condition = 507, RuleScalar_constant = 508, 
    RuleConcatenation = 509, RuleConstant_concatenation = 510, RuleConstant_multiple_concatenation = 511, 
    RuleModule_path_concatenation = 512, RuleModule_path_multiple_concatenation = 513, 
    RuleMultiple_concatenation = 514, RuleStreaming_concatenation = 515, 
    RuleStream_operator = 516, RuleSlice_size = 517, RuleStream_concatenation = 518, 
    RuleStream_expression = 519, RuleArray_range_expression = 520, RuleEmpty_queue = 521, 
    RuleTf_call = 522, RuleMethod_call = 523, RuleSystem_tf_call = 524, 
    RuleSubroutine_call = 525, RuleArgument = 526, RuleList_of_arguments = 527, 
    RuleArray_manipulation_call = 528, RuleRandomize_call = 529, RuleMethod_name = 530, 
    RuleArray_method_name = 531, RuleInc_or_dec_expression = 532, RuleConstant_expression = 533, 
    RuleConstant_mintypmax_expression = 534, RuleConstant_param_expression = 535, 
    RuleParam_expression = 536, RuleConstant_range_expression = 537, RuleConstant_part_select_range = 538, 
    RuleConstant_range = 539, RuleConstant_indexed_range = 540, RuleExpression = 541, 
    RuleConditional_expression = 542, RuleTagged_union_expression = 543, 
    RuleValue_range = 544, RuleMintypmax_expression = 545, RuleModule_path_conditional_expression = 546, 
    RuleModule_path_expression = 547, RuleModule_path_mintypmax_expression = 548, 
    RulePart_select_range = 549, RuleIndexed_range = 550, RuleGenvar_expression = 551, 
    RuleConstant_primary = 552, RuleModule_path_primary = 553, RulePrimary = 554, 
    RuleClass_qualifier = 555, RuleRange_expression = 556, RulePrimary_literal = 557, 
    RuleTime_literal = 558, RuleTime_unit = 559, RuleImplicit_class_handle = 560, 
    RuleBit_select = 561, RuleSelect = 562, RuleNonrange_select = 563, RuleConstant_bit_select = 564, 
    RuleConstant_select = 565, RuleConstant_cast = 566, RuleConstant_let_expression = 567, 
    RuleCast = 568, RuleNet_lvalue = 569, RuleVariable_lvalue = 570, RuleNonrange_variable_lvalue = 571, 
    RuleUnary_operator = 572, RuleBinary_operator = 573, RuleInc_or_dec_operator = 574, 
    RuleUnary_module_path_operator = 575, RuleBinary_module_path_operator = 576, 
    RuleNumber = 577, RulePackage_scope = 578, RulePsid = 579, RuleHierid = 580, 
    RuleSs = 581
  };

  explicit SysVerilogParser(antlr4::TokenStream *input);

  SysVerilogParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~SysVerilogParser() override;
  ...
  class Include_pathContext;
  class Library_descriptionContext;
  class Source_codeContext;
  ...
  class Select_expression2Context;
  ...
  class  Include_pathContext : public antlr4::ParserRuleContext {
  public:
    Include_pathContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_INCLUDEDIR();
  ...
  Include_pathContext* include_path();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_LIBRARY();
    SsContext *ss();
    ...
    antlr4::tree::TerminalNode *T_INCDIR();
    antlr4::tree::TerminalNode *T_INCLUDEDIR();
  ...
  class  Source_codeContext : public antlr4::ParserRuleContext {
  public:
    Source_codeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Source_codeContext* source_code();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *SEMI();
    LifetimeContext *lifetime();
    antlr4::tree::TerminalNode *T_EXTERN();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_MODULE();
    antlr4::tree::TerminalNode *T_MACROMODULE();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_ENDPROGRAM();
    Timeunits_declarationContext *timeunits_declaration();
    ...
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *T_PROGRAM();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *DOTSTAR();
    antlr4::tree::TerminalNode *RP();
    antlr4::tree::TerminalNode *SEMI();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_CHECKER();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_ENDCHECKER();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *RP();
  ...
  public:
    ...
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_ENDCLASS();
    antlr4::tree::TerminalNode *T_VIRTUAL();
    LifetimeContext *lifetime();
    Parameter_port_listContext *parameter_port_list();
    antlr4::tree::TerminalNode *T_EXTENDS();
    Class_typeContext *class_type();
    antlr4::tree::TerminalNode *T_IMPLEMENTS();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_PURE();
    antlr4::tree::TerminalNode *T_VIRTUAL();
  ...
  public:
    ...
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_ENDPACKAGE();
    LifetimeContext *lifetime();
    Timeunits_declarationContext *timeunits_declaration();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_PARAMETER();
    antlr4::tree::TerminalNode *T_TYPE();
    List_of_type_assignmentsContext *list_of_type_assignments();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_INPUT();
    antlr4::tree::TerminalNode *T_OUTPUT();
    antlr4::tree::TerminalNode *T_INOUT();
    antlr4::tree::TerminalNode *T_REF();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DFATAL();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *LP();
    ...
    List_of_argumentsContext *list_of_arguments();
    antlr4::tree::TerminalNode *DERROR();
    antlr4::tree::TerminalNode *DWARNING();
    antlr4::tree::TerminalNode *DINFO();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_CLOCKING();
    SsContext *ss();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_DISABLE();
    antlr4::tree::TerminalNode *T_IFF();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_DEFPARAM();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_BIND();
    SsContext *ss();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_CONFIG();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    std::vector<antlr4::tree::TerminalNode *> SEMI();
    antlr4::tree::TerminalNode* SEMI(size_t i);
    Design_statementContext *design_statement();
    antlr4::tree::TerminalNode *T_ENDCONFIG();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_DESIGN();
    HieridContext *hierid();
    antlr4::tree::TerminalNode *SEMI();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_INSTANCE();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_CELL();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *DOT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_LIBLIST();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
  ...
  public:
    ...
    Method_prototypeContext *method_prototype();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_FORKJOIN();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_RAND();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_PROTECTED();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_RAND();
    antlr4::tree::TerminalNode *T_RANDC();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_FUNCTION();
    std::vector<antlr4::tree::TerminalNode *> T_NEW();
    antlr4::tree::TerminalNode* T_NEW(size_t i);
    std::vector<antlr4::tree::TerminalNode *> SEMI();
    antlr4::tree::TerminalNode* SEMI(size_t i);
    antlr4::tree::TerminalNode *T_ENDFUNCTION();
    ...
    antlr4::tree::TerminalNode *T_SUPER();
    antlr4::tree::TerminalNode *DOT();
  ...
  public:
    ...
    Expression_or_distContext *expression_or_dist();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_SOFT();
    ...
    antlr4::tree::TerminalNode *T_FOREACH();
    PsidContext *psid();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_LOCALPARAM();
    antlr4::tree::TerminalNode *T_TYPE();
    List_of_type_assignmentsContext *list_of_type_assignments();
    Data_type_or_implicitContext *data_type_or_implicit();
    List_of_param_assignmentsContext *list_of_param_assignments();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SPECPARAM();
  ...
  class  UuuContext : public antlr4::ParserRuleContext {
  public:
    UuuContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *EOF();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_GENVAR();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_VECTORED();
    antlr4::tree::TerminalNode *T_SCALARED();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    Delay_controlContext *delay_control();
    antlr4::tree::TerminalNode *T_INTERCONNECT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_TYPEDEF();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    Constant_bit_selectContext *constant_bit_select();
    antlr4::tree::TerminalNode *DOT();
    ...
    antlr4::tree::TerminalNode *T_ENUM();
    antlr4::tree::TerminalNode *T_INTERFACE();
    Data_typeContext *data_type();
    std::vector<Variable_dimensionContext *> variable_dimension();
    Variable_dimensionContext* variable_dimension(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_NETTYPE();
    Data_typeContext *data_type();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *SEMI();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_STATIC();
    antlr4::tree::TerminalNode *T_AUTOMATIC();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *RC();
    antlr4::tree::TerminalNode *T_PACKED();
    antlr4::tree::TerminalNode *T_ENUM();
    ...
    antlr4::tree::TerminalNode* COMMA(size_t i);
    antlr4::tree::TerminalNode *T_STRING();
    antlr4::tree::TerminalNode *T_CHANDLE();
    antlr4::tree::TerminalNode *T_VIRTUAL();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *T_INTERFACE();
    ...
    Class_typeContext *class_type();
    antlr4::tree::TerminalNode *T_EVENT();
  ...
  class  Data_type_or_implicit1Context : public antlr4::ParserRuleContext {
  public:
    Data_type_or_implicit1Context(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Data_typeContext *data_type();
    std::vector<Packed_dimensionContext *> packed_dimension();
    Packed_dimensionContext* packed_dimension(size_t i);
  ...
  Data_type_or_implicit1Context* data_type_or_implicit1();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Class_type1Context *class_type1();
    antlr4::tree::TerminalNode *COLONCOLON();
  ...
  class  Class_type1Context : public antlr4::ParserRuleContext {
  public:
    Class_type1Context(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    ...
    antlr4::tree::TerminalNode *DUNIT();
    antlr4::tree::TerminalNode *T_LOCAL();
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> COLONCOLON();
    antlr4::tree::TerminalNode* COLONCOLON(size_t i);
    std::vector<antlr4::tree::TerminalNode *> SS();
    antlr4::tree::TerminalNode* SS(size_t i);
    antlr4::tree::TerminalNode *DUNIT();
    SsContext *ss();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_SHORTINT();
    antlr4::tree::TerminalNode *T_INT();
    antlr4::tree::TerminalNode *T_LONGINT();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_LOGIC();
    antlr4::tree::TerminalNode *T_REG();
    antlr4::tree::TerminalNode *T_CONST();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SHORTREAL();
    antlr4::tree::TerminalNode *T_REAL();
    antlr4::tree::TerminalNode *T_REALTIME();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SUPPLY0();
    antlr4::tree::TerminalNode *T_SUPPLY1();
    antlr4::tree::TerminalNode *T_TRI();
    antlr4::tree::TerminalNode *T_TRIAND();
    antlr4::tree::TerminalNode *T_TRIOR();
    antlr4::tree::TerminalNode *T_TRIREG();
    antlr4::tree::TerminalNode *T_TRI0();
    antlr4::tree::TerminalNode *T_TRI1();
    antlr4::tree::TerminalNode *T_UWIRE();
    antlr4::tree::TerminalNode *T_WIRE();
    antlr4::tree::TerminalNode *T_WAND();
    antlr4::tree::TerminalNode *T_WOR();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SIGNED();
    antlr4::tree::TerminalNode *T_UNSIGNED();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_STRUCT();
    antlr4::tree::TerminalNode *T_UNION();
    antlr4::tree::TerminalNode *T_TAGGED();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *RP();
    antlr4::tree::TerminalNode *T_HIGHZ1();
    antlr4::tree::TerminalNode *T_HIGHZ0();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SUPPLY0();
    antlr4::tree::TerminalNode *T_STRONG0();
    antlr4::tree::TerminalNode *T_PULL0();
    antlr4::tree::TerminalNode *T_WEAK0();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SUPPLY1();
    antlr4::tree::TerminalNode *T_STRONG1();
    antlr4::tree::TerminalNode *T_PULL1();
    antlr4::tree::TerminalNode *T_WEAK1();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *T_SMALL();
    antlr4::tree::TerminalNode *RP();
    antlr4::tree::TerminalNode *T_MEDIUM();
    antlr4::tree::TerminalNode *T_LARGE();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_ONESTEP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_PATHPULSE();
    antlr4::tree::TerminalNode *EQ();
    antlr4::tree::TerminalNode *LP();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_EXPORT();
    antlr4::tree::TerminalNode *T_FUNCTION();
    antlr4::tree::TerminalNode *T_TASK();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_CONTEXT();
    antlr4::tree::TerminalNode *T_PURE();
  ...
  class  Task_declContext : public antlr4::ParserRuleContext {
  public:
    Task_declContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_ENDTASK();
    std::vector<Tf_item_declarationContext *> tf_item_declaration();
    Tf_item_declarationContext* tf_item_declaration(size_t i);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *MINUSMINS();
    antlr4::tree::TerminalNode *STAR();
    antlr4::tree::TerminalNode *SS();
    antlr4::tree::TerminalNode *SLASH();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_MODPORT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_ASSERT();
    antlr4::tree::TerminalNode *T_PROPERTY();
    antlr4::tree::TerminalNode *LP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_ASSUME();
    antlr4::tree::TerminalNode *T_PROPERTY();
    antlr4::tree::TerminalNode *LP();
    Property_specContext *property_spec();
    antlr4::tree::TerminalNode *RP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_COVER();
    antlr4::tree::TerminalNode *T_PROPERTY();
    antlr4::tree::TerminalNode *LP();
    Property_specContext *property_spec();
    antlr4::tree::TerminalNode *RP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_EXPECT();
    antlr4::tree::TerminalNode *LP();
    Property_specContext *property_spec();
    antlr4::tree::TerminalNode *RP();
    Action_blockContext *action_block();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_COVER();
    antlr4::tree::TerminalNode *T_SEQUENCE();
    std::vector<antlr4::tree::TerminalNode *> LP();
    antlr4::tree::TerminalNode* LP(size_t i);
  ...
  public:
    ...
    antlr4::tree::TerminalNode* SEMI(size_t i);
    Property_specContext *property_spec();
    antlr4::tree::TerminalNode *T_ENDPROPERTY();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *RP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Sequence_exprContext *sequence_expr();
    antlr4::tree::TerminalNode *T_STRONG();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *RP();
    antlr4::tree::TerminalNode *T_WEAK();
    antlr4::tree::TerminalNode *T_NOT();
    std::vector<Property_exprContext *> property_expr();
    Property_exprContext* property_expr(size_t i);
    antlr4::tree::TerminalNode *BARARROW();
    antlr4::tree::TerminalNode *BAREQGT();
    antlr4::tree::TerminalNode *T_IF();
    Expression_or_distContext *expression_or_dist();
    antlr4::tree::TerminalNode *T_ELSE();
    antlr4::tree::TerminalNode *T_CASE();
    antlr4::tree::TerminalNode *T_ENDCASE();
    std::vector<Property_case_itemContext *> property_case_item();
    Property_case_itemContext* property_case_item(size_t i);
    antlr4::tree::TerminalNode *PMP();
    antlr4::tree::TerminalNode *PEP();
    antlr4::tree::TerminalNode *T_NEXTTIME();
    antlr4::tree::TerminalNode *LB();
    Constant_rangeContext *constant_range();
    antlr4::tree::TerminalNode *RB();
    antlr4::tree::TerminalNode *T_S_NEXTTIME();
    antlr4::tree::TerminalNode *T_ALWAYS();
    Cycle_delay_const_range_expressionContext *cycle_delay_const_range_expression();
    antlr4::tree::TerminalNode *T_S_ALWAYS();
    antlr4::tree::TerminalNode *T_S_EVENTUALLY();
    antlr4::tree::TerminalNode *T_EVENTUALLY();
    antlr4::tree::TerminalNode *T_ACCEPT_ON();
    antlr4::tree::TerminalNode *T_REJECT_ON();
    antlr4::tree::TerminalNode *T_SYNC_ACCEPT_ON();
    antlr4::tree::TerminalNode *T_SYNC_REJECT_ON();
    Property_instanceContext *property_instance();
    Clocking_eventContext *clocking_event();
    antlr4::tree::TerminalNode *T_OR();
    antlr4::tree::TerminalNode *T_AND();
    antlr4::tree::TerminalNode *T_UNTIL();
    antlr4::tree::TerminalNode *T_S_UNTIL();
    antlr4::tree::TerminalNode *T_UNTIL_WITH();
    antlr4::tree::TerminalNode *T_S_UNTIL_WITH();
    antlr4::tree::TerminalNode *T_IMPLIES();
    antlr4::tree::TerminalNode *T_IFF();
  ...
  public:
    ...
    antlr4::tree::TerminalNode* SEMI(size_t i);
    Sequence_exprContext *sequence_expr();
    antlr4::tree::TerminalNode *T_ENDSEQUENCE();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *RP();
    std::vector<Assertion_variable_declarationContext *> assertion_variable_declaration();
    Assertion_variable_declarationContext* assertion_variable_declaration(size_t i);
  ...
  public:
    ...
    Data_type_or_implicitContext *data_type_or_implicit();
    antlr4::tree::TerminalNode *T_SEQUENCE();
    antlr4::tree::TerminalNode *T_UNTYPED();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_FIRST_MATCH();
    antlr4::tree::TerminalNode *T_THROUGHOUT();
    Clocking_eventContext *clocking_event();
    antlr4::tree::TerminalNode *T_AND();
    antlr4::tree::TerminalNode *T_INTERSECT();
    antlr4::tree::TerminalNode *T_OR();
    antlr4::tree::TerminalNode *T_WITHIN();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *T_DIST();
    antlr4::tree::TerminalNode *LC();
    Dist_listContext *dist_list();
    antlr4::tree::TerminalNode *RC();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_LET();
    SsContext *ss();
    antlr4::tree::TerminalNode *EQ();
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *SEMI();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_COVERGROUP();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_ENDGROUP();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *RP();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *EQ();
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *T_TYPE_OPTION();
    Constant_expressionContext *constant_expression();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Data_type_or_implicitContext *data_type_or_implicit();
    antlr4::tree::TerminalNode *T_COVERPOINT();
    std::vector<ExpressionContext *> expression();
    ExpressionContext* expression(size_t i);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *RC();
    antlr4::tree::TerminalNode *T_WILDCARD();
    antlr4::tree::TerminalNode *LB();
    antlr4::tree::TerminalNode *RB();
    antlr4::tree::TerminalNode *T_WITH();
    std::vector<antlr4::tree::TerminalNode *> LP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_BINS();
    antlr4::tree::TerminalNode *T_ILLEGAL_BINS();
    antlr4::tree::TerminalNode *T_IGNORE_BINS();
  ...
  class  Select_expression2Context : public antlr4::ParserRuleContext {
  public:
    Select_expression2Context(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Select_expressionContext *select_expression();
    Select_expression2Context *select_expression2();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_WITH();
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *T_MATCHES();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_BINSOF();
    antlr4::tree::TerminalNode *LP();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_PULLDOWN();
    ...
    antlr4::tree::TerminalNode *T_PULLUP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_CMOS();
    antlr4::tree::TerminalNode *T_RCMOS();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_BUFIF0();
    antlr4::tree::TerminalNode *T_BUFIF1();
    antlr4::tree::TerminalNode *T_NOTIF0();
    antlr4::tree::TerminalNode *T_NOTIF1();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_NMOS();
    antlr4::tree::TerminalNode *T_PMOS();
    antlr4::tree::TerminalNode *T_RNMOS();
    antlr4::tree::TerminalNode *T_RPMOS();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_AND();
    antlr4::tree::TerminalNode *T_NAND();
    antlr4::tree::TerminalNode *T_OR();
    antlr4::tree::TerminalNode *T_NOR();
    antlr4::tree::TerminalNode *T_XOR();
    antlr4::tree::TerminalNode *T_XNOR();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_BUF();
    antlr4::tree::TerminalNode *T_NOT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_TRANIF0();
    antlr4::tree::TerminalNode *T_TRANIF1();
    antlr4::tree::TerminalNode *T_RTRANIF1();
    antlr4::tree::TerminalNode *T_RTRANIF0();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_TRAN();
    antlr4::tree::TerminalNode *T_RTRAN();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_POUND();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    SsContext *ss();
    std::vector<HieridContext *> hierid();
    HieridContext* hierid(size_t i);
    antlr4::tree::TerminalNode *SEMI();
    Parameter_value_assignmentContext *parameter_value_assignment();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_GENERATE();
    antlr4::tree::TerminalNode *T_ENDGENERATE();
    antlr4::tree::TerminalNode *T_BEGIN();
    antlr4::tree::TerminalNode *COLON();
    SsContext *ss();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_ALIAS();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_INITIAL();
    Statement_or_nullContext *statement_or_null();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_ALWAYS();
    antlr4::tree::TerminalNode *T_ALWAYS_COMB();
    antlr4::tree::TerminalNode *T_ALWAYS_LATCH();
    antlr4::tree::TerminalNode *T_ALWAYS_FF();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_FINAL();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *BAREQ();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_ASSIGN();
    antlr4::tree::TerminalNode *T_DEASSIGN();
    Variable_lvalueContext *variable_lvalue();
    antlr4::tree::TerminalNode *T_FORCE();
    Net_assignmentContext *net_assignment();
    antlr4::tree::TerminalNode *T_RELEASE();
    Net_lvalueContext *net_lvalue();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_FORK();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_JOIN_ANY();
    antlr4::tree::TerminalNode *T_JOIN_NONE();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_REPEAT();
    antlr4::tree::TerminalNode *LP();
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *RP();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *T_FORK();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_WAIT_ORDER();
    std::vector<HieridContext *> hierid();
    HieridContext* hierid(size_t i);
    Action_blockContext *action_block();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *MINUSGTGT();
    HieridContext *hierid();
    antlr4::tree::TerminalNode *SEMI();
    Delay_or_event_controlContext *delay_or_event_control();
    antlr4::tree::TerminalNode *ARROW();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_UNIQUE();
    antlr4::tree::TerminalNode *T_UNIQUE0();
    antlr4::tree::TerminalNode *T_PRIORITY();
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> ANDANDAND();
    antlr4::tree::TerminalNode* ANDANDAND(size_t i);
  ...
  class  CcaseContext : public antlr4::ParserRuleContext {
  public:
    CcaseContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_MATCHES();
    antlr4::tree::TerminalNode *T_ENDCASE();
    std::vector<Case_pattern_itemContext *> case_pattern_item();
    Case_pattern_itemContext* case_pattern_item(size_t i);
    antlr4::tree::TerminalNode *T_INSIDE();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_CASE();
    antlr4::tree::TerminalNode *T_CASEZ();
    antlr4::tree::TerminalNode *T_CASEX();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *COLON();
    Statement_or_nullContext *statement_or_null();
    antlr4::tree::TerminalNode *ANDANDAND();
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *T_DEFAULT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_RANDCASE();
    antlr4::tree::TerminalNode *T_ENDCASE();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_FOREVER();
    Statement_or_nullContext *statement_or_null();
    antlr4::tree::TerminalNode *T_REPEAT();
    antlr4::tree::TerminalNode *LP();
    ExpressionContext *expression();
    ...
    std::vector<Loop_variablesContext *> loop_variables();
    Loop_variablesContext* loop_variables(size_t i);
  ...
  public:
    ...
    Clocking_eventContext *clocking_event();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_ENDCLOCKING();
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *T_DEFAULT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_RANDSEQUENCE();
    antlr4::tree::TerminalNode *LP();
    antlr4::tree::TerminalNode *RP();
    antlr4::tree::TerminalNode *T_ENDSEQUENCE();
    SsContext *ss();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SPECIFY();
    antlr4::tree::TerminalNode *T_ENDSPECIFY();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_PULSESTYLE_ONEVENT();
    List_of_path_outputsContext *list_of_path_outputs();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_PULSESTYLE_ONDETECT();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SHOWCANCELLED();
    List_of_path_outputsContext *list_of_path_outputs();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *T_NOSHOWCANCELLED();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *MCOLON();
    antlr4::tree::TerminalNode *COLON();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_POSEDGE();
    antlr4::tree::TerminalNode *T_NEGEDGE();
    antlr4::tree::TerminalNode *T_EDGE();
  ...
  public:
    ...
    Edge_sensitive_path_declarationContext *edge_sensitive_path_declaration();
    Simple_path_declarationContext *simple_path_declaration();
    antlr4::tree::TerminalNode *T_IFNONE();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SETUP();
    antlr4::tree::TerminalNode *LP();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_HOLD();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SETUPHOLD();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_RECOVERY();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_REMOVAL();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_RECREM();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_SKEW();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_TIMESKEW();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_FULLSKEW();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_WIDTH();
    antlr4::tree::TerminalNode *LP();
    Controlled_reference_eventContext *controlled_reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_NOCHANGE();
    antlr4::tree::TerminalNode *LP();
    Reference_eventContext *reference_event();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *System_identifier();
    antlr4::tree::TerminalNode *LP();
    List_of_argumentsContext *list_of_arguments();
    antlr4::tree::TerminalNode *RP();
    Data_typeContext *data_type();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *T_RANDOMIZE();
    std::vector<antlr4::tree::TerminalNode *> LP();
    antlr4::tree::TerminalNode* LP(size_t i);
    std::vector<antlr4::tree::TerminalNode *> RP();
    antlr4::tree::TerminalNode* RP(size_t i);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *EQEQ();
    antlr4::tree::TerminalNode *NEE();
    antlr4::tree::TerminalNode *EQEQQUEST();
    ...
    antlr4::tree::TerminalNode *SQUIGCARET();
    antlr4::tree::TerminalNode *CARETSQUIG();
    antlr4::tree::TerminalNode *GTGT();
    antlr4::tree::TerminalNode *LTLT();
    antlr4::tree::TerminalNode *GTGTGT();
    antlr4::tree::TerminalNode *LTLTLT();
    antlr4::tree::TerminalNode *ARROW();
    antlr4::tree::TerminalNode *LTMINUSGT();
    antlr4::tree::TerminalNode *PLUSPLUS();
    antlr4::tree::TerminalNode *MINUSMINS();
    antlr4::tree::TerminalNode *SQUIGBAR();
    antlr4::tree::TerminalNode *SQUIGAND();
    antlr4::tree::TerminalNode *QUES();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *T_INSIDE();
    antlr4::tree::TerminalNode *LC();
  ...
  public:
    ...
    Sequence_method_callContext *sequence_method_call();
    CastContext *cast();
    antlr4::tree::TerminalNode *T_THIS();
    antlr4::tree::TerminalNode *DOLLAR();
    antlr4::tree::TerminalNode *T_NULL();
    antlr4::tree::TerminalNode *LP();
    std::vector<ExpressionContext *> expression();
  ...
  public:
    ...
    Time_literalContext *time_literal();
    NumberContext *number();
    antlr4::tree::TerminalNode *UNLIT();
    antlr4::tree::TerminalNode *String_literal();
  ...
  class  PsidContext : public antlr4::ParserRuleContext {
  public:
    PsidContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    SsContext *ss();
    Package_scopeContext *package_scope();
  ...
  class  HieridContext : public antlr4::ParserRuleContext {
  public:
    HieridContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<SsContext *> ss();
    SsContext* ss(size_t i);
    std::vector<antlr4::tree::TerminalNode *> DOT();
    antlr4::tree::TerminalNode* DOT(size_t i);
    antlr4::tree::TerminalNode *DROOT();
    Implicit_class_handleContext *implicit_class_handle();
    std::vector<antlr4::tree::TerminalNode *> LB();
    antlr4::tree::TerminalNode* LB(size_t i);
    std::vector<Constant_expressionContext *> constant_expression();
  ...
  class  SsContext : public antlr4::ParserRuleContext {
  public:
    SsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Escape_identifier();
