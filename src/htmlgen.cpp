...
void HtmlGenerator::writeTabData()
{
 ...
 //  exit(0);
  ...
  mgr.copyResource("phase.png",dname);
  mgr.copyResource("out.png",dname);
  mgr.copyResource("input.png",dname);
  mgr.copyResource("logic.png",dname);
  mgr.copyResource("func.png",dname);
  Doxygen::indexList->addImageFile("nav_g.png");
  //Doxygen::indexList->addImageFile("phase.png");
...
void HtmlGenerator::writeSearchData(const QCString &dname)
{
  ...
  mgr.copyResource("closedmag_d.svg",dname);
