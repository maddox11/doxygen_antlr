...
//////////////////////////////////////////////////////////////////////////
                                    ...
                                    bool isTemplate) override
    {
      ...
      switch(compType)
      {
        ...
        case ClassDef::Package:    result+=" Package"; break;
        case ClassDef::Program:    result+=" Program"; break;
        case ClassDef::Checker:    result+=" Checker"; break;
        case ClassDef::Configuration:    result+=" Configuration"; break;
        default: break;
      }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { // single is true implies a single file
      ...
      switch(compType)
      {
        case ClassDef::Class:      result+=vhdlOpt?"design unit":"classl"; break;
        case ClassDef::Struct:     result+="struct"; break;
        case ClassDef::Union:      result+="union"; break;
        case ClassDef::Checker:  result+="checker"; break;
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      QCString result((first_capital ? "Class" : "classl"));
...
//////////////////////////////////////////////////////////////////////////
    ...
    QCString trCompoundReferenceSlice(const QCString &clName, ClassDef::CompoundType compType, bool isLocal) override
    {
      ...
      switch(compType)
      {
        case ClassDef::Class:      result+=" ClassMod"; break;
        case ClassDef::Struct:     result+=" Struct"; break;
        case ClassDef::Union:      result+=" Union"; break;
        case ClassDef::Interface:  result+=" Interface1"; break;
        case ClassDef::Protocol:   result+=" Protocol"; break;
        case ClassDef::Category:   result+=" Category"; break;
        case ClassDef::Exception:  result+=" Exception"; break;
        default: break;
